...
public class MBNExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    static {
        classNames.put("http://localhost/^^SOAP_Person",MBNSOAP_Person.class);
        classNames.put("http://localhost/^^ListPeople_Response",MBNListPeople_Response.class);
    } 
    ...
    public static void setDateTimeConverter(MBNDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new MBNStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static MBNDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static MBNDateTimeConverter dateTimeConverter = new MBNStandardDateTimeConverter();

    public MBNExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public MBNExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new MBNMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=MBNHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    public SoapObject GetSoapObject(Element detailElement) {
        ...
        catch (java.lang.Exception e)
        {
			if(enableLogging)
			{
				android.util.Log.e(MBNExtendedSoapSerializationEnvelope.TAG,"Error occured",e);
			}
        }
        return null;
    }
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,MBNExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=MBNHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
